        ...
        <div class="p-access-box">
          ...
          <div class="p-access-box__buttons">
            <div class="p-access-box__bokking">
              <a href="<?= home_url('/reservation/'); ?>" class="c-button-cir-md--main">
            ...
            <div class="p-access-box__contact">
              <a href="<?= home_url('/contact/'); ?>" class="c-button-cir-md">
...
<div class="p-footer-cta">
  ...
  <div class="p-footer-cta__right">
    <a href="<?= get_permalink(get_page_by_path('reservation')->ID); ?>" class="c-button-squ-lg">
...
<div class="p-side-cta u-lg-show">
  <a href="<?= get_permalink(get_page_by_path('reservation')->ID); ?>" class="p-side-cta__link">
